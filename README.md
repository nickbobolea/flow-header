...
<img src="visualizations/geometry.png">
...
The case simulation data, written to the `postProcessing` folder using the run-time functions defined in [**Runtime Control**](#Runtime-Control) section, is processed using the `flow-header.ipynb` [JupyterLab](https://jupyter.org/) notebook located in the study folder `visualizations`. The notebook generates interactive parameter plots using [Plotly](https://plotly.com/) and can be used to monitor the solver execution. The [notebook](http://htmlpreview.github.io/?https://github.com/nickbobolea/flow-header/blob/main/visualizations/flow-header.html) and the [interactive parameter plots](http://htmlpreview.github.io/?https://github.com/nickbobolea/flow-header/blob/main/visualizations/flow-header-plots.html) are available in html format.
